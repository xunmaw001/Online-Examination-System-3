    ...
    <div class="container py-3">
        ...
        <div class="row">
            ...
            <div class="col-lg-4 event-right wthree-event-right">
                ...
                <input type="text" v-model="searchForm.examquestionName" placeholder="试题名称" autocomplete="off"
                       class="search-input">     
                <select class="search-input" v-model="searchForm.kemuTypes">
                    <option value="" selected>请选择科目</option>
                    <option v-for="(item,index) in kemuTypesList" v-bind:key="index"
                        ...
                        <div v-if="isAuth('examquestion','新增')"  @click="jump('../examquestion/add.jsp')" class="button-submit"><i class="layui-icon">&#xe654;</i>添加</div>
                    </div>
                </form>
                <div class="tags tags1">
                    ...
                    <ul>
                        <li class="thisTableType-search">
                            <a :class='searchForm.examquestionTypes=="" || searchForm.examquestionTypes==null?"thisTableType-search-hover":""'>全部</a>
                        </li>
                        <li v-for="(item,index) in examquestionTypesList" :key="item.codeIndex" :index="item.codeIndex" class="thisTableType-search" >
                            <a :class='searchForm.examquestionTypes==item.codeIndex?"thisTableType-search-hover":""'>{{item.indexName}}</a>
                        </li>
                    </ul>
                </div>
            </div>
