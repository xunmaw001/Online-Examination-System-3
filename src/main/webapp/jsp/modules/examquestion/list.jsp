                            ...
                            <div class="table-responsive mb-3" id="tableDiv">
                                ...
                                <table id="tableId" class="table table-bordered table-striped">
                                    ...
                                    <tr>
                                        ...
                                        <th onclick="sort('examquestion_name')">试题名称<i id="examquestionNameIcon" class="fa fa-sort"></i></th>
                                        <th onclick="sort('kemu_types')">科目<i id="kemuTypesIcon" class="fa fa-sort"></i></th>
<!--                                        <th onclick="sort('examquestion_options')">选项，json字符串<i id="examquestionOptionsIcon" class="fa fa-sort"></i></th>-->
                                        <th onclick="sort('examquestion_answer')">正确答案<i id="examquestionAnswerIcon" class="fa fa-sort"></i></th>
                                        <th onclick="sort('examquestion_analysis')">答案解析<i id="examquestionAnalysisIcon" class="fa fa-sort"></i></th>
                                        <th onclick="sort('examquestion_types')">试题类型<i id="examquestionTypesIcon" class="fa fa-sort"></i></th>
<!--                                        <th onclick="sort('examquestion_sequence')">试题排序，值越大排越前面<i id="examquestionSequenceIcon" class="fa fa-sort"></i></th>-->
                                        <th>操作</th>
                                    </tr>
                                    </thead>
                                    <tbody id="thisTbody">
    ...
    <!-- 本表的查询条件 -->
        ...
        function setDataRow(item, number) {
            ...
            //选项，json字符串
            /*var examquestionOptionsCell = document.createElement('td');
            examquestionOptionsCell.innerHTML = item.examquestionOptions;
            row.appendChild(examquestionOptionsCell);*/
            ...
            //试题排序，值越大排越前面
            /*var examquestionSequenceCell = document.createElement('td');
            examquestionSequenceCell.innerHTML = item.examquestionSequence;
            row.appendChild(examquestionSequenceCell);*/
        ...
        function remove(id) {
            ...
            if (mymessage == true) {
                ...
                httpJson("examquestion/delete", "POST", paramArray, (res) => {
                    if(res.code == 0){
                        getDataList();
