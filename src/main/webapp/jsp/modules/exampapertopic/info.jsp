            ...
            <div class="row breadcrumb-bar">
                ...
                <div class="col-md-6">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">试卷选题登记</li>
                    </ol>
                </div>
            </div>
        </div>
                    ...
                    <div class="widget-area-2 lochana-box-shadow">
                        ...
                        <form id="addOrUpdateForm">
                            ...
                            <!-- 级联表所有字段 -->
                                    ...
                                    <div class="form-group col-md-6" v-if="ruleForm.examquestionTypes==1||ruleForm.examquestionTypes==2">
                                        <label>选项</label>
                                ...
                                <input id="examquestionId" name="examquestionId" v-model="ruleForm.examquestionId" readonly type="hidden">
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input style="width: 450px" id="exampapertopicNumber" name="exampapertopicNumber" class="form-control"
                                               v-model="ruleForm.exampapertopicNumber" readonly>
                                    </div>
    ...
    var vm = new Vue({
        ...
        beforeCreate: function () {
            ...
            if (id != null && id != "" && id != "null") {
                $.ajax({
                    type: "GET",
                    url: baseUrl + "exampapertopic/info/" + id,
