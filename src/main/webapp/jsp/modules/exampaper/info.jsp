                    ...
                    <div class="widget-area-2 lochana-box-shadow">
                        ...
                        <form id="addOrUpdateForm">
                            ...
                            <!-- 本表所有字段 -->
                                    ...
                                    <div class="form-group col-md-6">
                                        <label>试卷总分数</label>
                                        <input style="width: 450px" id="exampaperMyscore" name="exampaperMyscore" class="form-control"
                                               v-model="ruleForm.exampaperMyscore" readonly>
                                    </div>
                                ...
                                <div class="form-group col-md-6">
                                    <label>组卷方式</label>
                                    <input style="width: 450px" id="zujuanValue" name="zujuanValue" class="form-control"
                                           v-model="ruleForm.zujuanValue" readonly>
                                </div>
