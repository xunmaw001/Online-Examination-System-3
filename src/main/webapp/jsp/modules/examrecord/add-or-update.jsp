                    ...
                    <div class="widget-area-2 lochana-box-shadow">
                        ...
                        <form id="addOrUpdateForm">
                            ...
                            <!-- 当前表的字段 -->
                                    ...
                                    <div class="form-group col-md-6 examrecordUuidNumberDiv">
                                        <label>考试编号</label>
                                ...
                                <input id="exampaperId" name="exampaperId" type="hidden">
                                    <div class="form-group col-md-6 totalScoreDiv">
                                        <label>所得总分</label>
                                        <input style="width: 450px" id="totalScore" name="totalScore" class="form-control"
                                               onchange="integerChickValue(this)"  placeholder="所得总分">
                                    </div>
...
<script>
            ...
            if(window.sessionStorage.getItem('role') != '用户'){//当前登录用户不为这个
                if($("#yonghuId") !=null){
                    ...
                    if(yonghuId == null || yonghuId =='' || yonghuId == 'null'){
                        layui.layer.msg("考试用户不能为空", {time: 2000,icon: 5});
                        return;
                    }
                }
            }
            if(window.sessionStorage.getItem('role') != '试卷表'){//当前登录用户不为这个
                if($("#exampaperId") !=null){
                    ...
                    if(exampaperId == null || exampaperId =='' || exampaperId == 'null'){
                        layui.layer.msg("所属试卷id（外键）不能为空", {time: 2000,icon: 5});
                        return;
                    }
                }
            }
    ...
    function getDetails() {
        ...
        if (addexamrecord != null && addexamrecord != "" && addexamrecord != "null") {
            //注册表单验证
            $(validform());
            $("#examrecordUuidNumber").val(new Date().getTime()+Math.ceil(Math.random()*10));//设置唯一号
