                            ...
                            <div class="table-responsive mb-3" id="tableDiv">
                                ...
                                <table id="tableId" class="table table-bordered table-striped">
                                    ...
                                    <tr>
                                        ...
                                        <th onclick="sort('examrecord_uuid_number')">考试编号<i id="examrecordUuidNumberIcon" class="fa fa-sort"></i></th>
                                        <th onclick="sort('total_score')">所得总分<i id="totalScoreIcon" class="fa fa-sort"></i></th>
                                        <th onclick="sort('insert_time')">考试时间<i id="insertTimeIcon" class="fa fa-sort"></i></th>
                                        <th>操作</th>
                                    </tr>
                                    </thead>
                                    <tbody id="thisTbody">
    ...
    <script>
        ...
        function exportExcel() {
            excel = new ExcelGen({
                "src_id": "tableId",
                "show_header": true,
                "file_name": 'examrecord.xlsx'
            });
            excel.generate();
        }

        // 查看详情
        function detail(examrecordUuidNumber) {
            window.sessionStorage.setItem("examrecordUuidNumber", examrecordUuidNumber);
