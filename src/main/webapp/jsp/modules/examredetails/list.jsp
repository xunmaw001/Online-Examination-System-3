                            ...
                            <div class="table-responsive mb-3" id="tableDiv">
                                ...
                                <table id="tableId" class="table table-bordered table-striped">
                                    ...
                                    <tr>
                                        ...
                                        <th>试卷编号<i id="examredetailsUuidNumberIcon" class="fa fa-sort"></i></th>
...
<!--                                        <th>用户头像<i id="yonghuPhotoIcon" class="fa fa-sort"></i></th>-->
                                        <th onclick="sort('examredetails_myanswer')">考生答案<i id="examredetailsMyanswerIcon" class="fa fa-sort"></i></th>
                                        <th onclick="sort('examredetails_myscore')">试题得分<i id="examredetailsMyscoreIcon" class="fa fa-sort"></i></th>
                                        <th>操作</th>
                                    </tr>
                                    </thead>
                                    <tbody id="thisTbody">
    ...
    <script>
        ...
        var examredetailsUuidNumber = null;//考试记录id
        ...
        function edit(id) {
            ...
            window.sessionStorage.setItem("examrecordUuidNumber",examredetailsUuidNumber);
    ...
    //查询当前表搜索条件所有列表
        ...
        layui.use(['layer', 'carousel', 'jquery', 'form', 'upload', 'laydate', 'rate'], function () {
            ...
            var $=jquery;
            examredetailsUuidNumber=window.sessionStorage.getItem("examrecordUuidNumber");
            window.sessionStorage.removeItem("examrecordUuidNumber");
            if(examredetailsUuidNumber == null || examredetailsUuidNumber==""){
                layui.layer.msg("获取不到考试id,请去考试记录管理中点击过来此页面", {time: 3000,icon: 5},function(){
                    window.location.href = "../examrecord/list.jsp";
                });
            }
            //查询当前表的搜索下拉框
            getDataList();
